...
import com.example.fitfoood.databinding.ArticleRowListBinding
 ...
 *
 * This adapter is used to show article data in list view
 *
...
class ArticleListAdapter(private var listItem: List<ArticleItem>) : RecyclerView.Adapter<ArticleListAdapter.ViewHolder>() {
     ...
     *
     * @param binding article row list binding
     */
    class ViewHolder(private val binding: ArticleRowListBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ArticleRowListBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra(Constants.EXTRA_ARTICLE, artikel)
